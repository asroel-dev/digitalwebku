...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-12 text-center">
                                                    <p class="mb-0 mt-3"><small class="text-dark me-2">Belum memiliki
                                                            akun ?</small> <a href="<?php echo e(route('register')); ?>"
                                                            class="text-dark fw-bold">Daftar Sekarang</a></p>
                                                </div>
                                                <!--end col-->
                                            </div>
                                            <!--end row-->
...
<?php /**PATH /Users/asrulramadhan/Laravel/digitalwebku/resources/views/auth/login.blade.php ENDPATH**/ ?>