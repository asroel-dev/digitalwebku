                        ...
                        <div class="feature-one__top">
                            <div class="feature-one__top-inner">
                                <div class="feature-one__top-title-box">
                                    <h3 class="feature-one__top-title"><a href="/dokumen?kategori=<?php echo e($item->kategori_seo); ?>"><?php echo e($item->nama_kategori); ?> <br>
                                             </a></h3>
                                </div>
                            </div>
                        </div>
                        <p class="feature-one__text"><?php echo e($item->deskripsi); ?></p>
                        <a href="/dokumen?kategori=<?php echo e($item->kategori_seo); ?>" class="thm-btn feature-one__btn">Lihat</a>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /usr/share/nginx/html/disperkimtan/resources/views/frontend/index.blade.php ENDPATH**/ ?>