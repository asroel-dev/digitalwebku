                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="form-icon position-relative">
                                                                ...
                                                                <input type="text" class="form-control ps-5 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>" placeholder="Masukkan Nama Lengkap" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus >
                                                            </div>
                                                        </div>
                                                    </div>
...
unset($__errorArgs, $__bag); ?>" placeholder="" name="nama_website" value="<?php echo e(old('nama_website')); ?>" required autocomplete="name" autofocus >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" pattern="\S(.*\S)?" class="form-control" name="subdomain" value="<?php echo e(old('subdomain')); ?>"  required>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="form-icon position-relative">
                                                                ...
                                                                <input type="email" class="form-control ps-5 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Password" name="password" required autocomplete="password" >
...
unset($__errorArgs, $__bag); ?>" placeholder="Konfirmasi Password" name="password_confirmation" required autocomplete="new-password" >
                                                                <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="mx-auto">
                                                        <p class="mb-0 mt-3"><small class="text-dark me-2">Sudah punya akun ?</small> <a href="<?php echo e(route('login')); ?>" class="text-dark fw-bold">Login disini</a></p>
                                                    </div>
                                                </div><!--end row-->
                                            </form>  
                                        </div>
...
</html><?php /**PATH /Users/asrulramadhan/Laravel/digitalwebku/resources/views/auth/register.blade.php ENDPATH**/ ?>