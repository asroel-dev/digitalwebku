 <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
     ...
     <div class="aside-logo flex-column-auto" id="kt_aside_logo">
         <a href="">
             <h4 class="text-white">Pasti Beraksi</h4>
         </a>
     ...
     <div class="aside-menu flex-column-fluid">
         <div class="hover-scroll-overlay-y my-2 py-5 py-lg-8" id="kt_aside_menu_wrapper" data-kt-scroll="true"
             ...
             <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                 ...
                 <div data-kt-menu-trigger="click" class="menu-item  <?php if(Route::is('kategori.index') || Route::is('kategoriberita.index') || Route::is('layanan.index')  ): ?> show <?php endif; ?> menu-accordion">
                     ...
                     <div class="menu-sub menu-sub-accordion menu-active-bg">
                         ...
                         <div class="menu-item">
                             <a class="menu-link <?php if(Route::is('layanan.index')): ?> active <?php endif; ?>"
                 ...
                 <div class="menu-item">
                     <a class="menu-link <?php if(Route::is('berita.index') || Route::is('berita.create') || Route::is('berita.edit')): ?> active <?php endif; ?>"
                         ...
                         <span class="menu-title">Berita dan Artikel</span>
                     </a>
                 </div>
                 <div class="menu-item">
                     <a class="menu-link <?php if(Route::is('halamanstatis.index') || Route::is('halamanstatis.create') || Route::is('halamanstatis.edit')): ?> active <?php endif; ?>"
                         href="<?php echo e(route('halamanstatis.index')); ?>">
                         <span class="menu-icon">
                             <i class="bi bi-newspaper fs-3"></i>
                         </span>
                         <span class="menu-title">Halaman Statis</span>
                     </a>
                 </div>

                 <div class="menu-item">
                     <a class="menu-link <?php if(Route::is('newsletter.index')): ?> active <?php endif; ?>"
                         href="<?php echo e(route('newsletter.index')); ?>">
                         <span class=" menu-icon">
                 ...
                 <div class="menu-item">
                    <a class="menu-link <?php if(Route::is('faq.index')): ?> active <?php endif; ?>"
             ...
             <div class="menu-item">
                <a class="menu-link <?php if(Route::is('profil.index')): ?> active <?php endif; ?>"
            ...
            <div class="menu-item">
                <a class="menu-link <?php if(Route::is('about.index')): ?> active <?php endif; ?>"
...
<?php /**PATH /Users/asrulramadhan/Sites/sipbm-new/pastiberaksi/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>