...
<?php $__env->startSection('title','Buat Halaman'); ?>
<?php $__env->startSection('content'); ?>
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a href="<?php echo e(route('halaman.index')); ?>" class="btn btn-warning"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
            </div>
            <form method="POST" action="<?php echo e(route('halaman.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" placeholder="Masukkan Judul" name="judul" required />
...
unset($__errorArgs, $__bag); ?>" name="isi_halaman" id="isi_halaman"></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asrulramadhan/Sites/satpol/resources/views/admin/halaman/create.blade.php ENDPATH**/ ?>