    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <form method="POST" class="form" action="<?php echo e(route('kategori.store')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input type="text" class="form-control form-control-solid" placeholder="Masukkan Nama Kategori" name="name" required />
                    </div>
                    <div class="d-flex flex-column mb-8 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
...
<div class="modal fade" id="editKategori" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <form class="form" action="<?php echo e(route('kategori.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input type="text" id="editNamaCategory" class="form-control form-control-solid" required placeholder="Masukkan Nama Category" name="name" />
                    </div>
                    <div class="d-flex flex-column mb-8 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
...
<script>
    ...
    function editData(id) {
        ...
        $.ajax({
            url: "<?php echo e(route('kategori.edit')); ?>",
            method: "POST",
            data: {
                _token: _token,
                id: id
    ...
    function hapus(id) {
        var _token = "<?php echo e(csrf_token()); ?>";
        $.ajax({
            url: "<?php echo e(route('kategori.destroy')); ?>",
            method: "POST",
            data: {
                _token: _token,
                id: id
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asrulramadhan/Laravel/digitalwebku/resources/views/admin/kategori/index.blade.php ENDPATH**/ ?>