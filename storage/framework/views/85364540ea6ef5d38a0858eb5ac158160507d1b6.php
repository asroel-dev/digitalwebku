                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">Judul (id)</span>
...
unset($__errorArgs, $__bag); ?>" name="isiberita" id="isiberita"></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-right mt-5">
                        ...
                        <button name="draft" value="N" class="btn btn-sm btn-light btn-block">Simpan Sebagai Draft</button>
        ...
        <div class="col-lg-4 col-md-12 col-sm-12">
            ...
            <div class="card shadow mb-3 ">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <select class="form-control <?php $__errorArgs = ['id_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="id_kategori">
                            ...
                            <option value="<?php echo e($category->id_kategori); ?>"><?php echo e($category->nama_kategori); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asrulramadhan/Sites/perkimtan/perkimtan/resources/views/admin/berita/create.blade.php ENDPATH**/ ?>