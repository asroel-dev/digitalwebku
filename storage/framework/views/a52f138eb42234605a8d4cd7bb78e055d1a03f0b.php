    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <form method="POST" class="form" action="<?php echo e(route('dokumen.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <select class="form-control" name="kategori_file" required>
...
<div class="modal fade" id="editAplikasi" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <form class="form" action="<?php echo e(route('dokumen.update')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <select class="form-control" id="kategoriEdit" name="kategori_file" required>
                            <option value="">Pilih Kategori</option>
                            <?php $__currentLoopData = $kategori_file; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($item->id); ?>"><?php echo e($item->nama_kategori); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script>
    $(document).ready(function() {
        ...
        function load_data(unit = '') {
            $('#tableAplikasi').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url: "<?php echo e(route('dokumen.index')); ?>",
                    data: {
                        unit: unit,
                    }
                },
    ...
    function editData(id) {
        ...
        $.ajax({
            url: "<?php echo e(route('dokumen.edit')); ?>",
            method: "POST",
            data: {
                _token: _token,
                id: id
            ...
            success: function(data) {
                ...
                $('#kategoriEdit').val(data.kategori_file);
    ...
    function hapus(id) {
        var _token = "<?php echo e(csrf_token()); ?>";
        $.ajax({
            url: "<?php echo e(route('dokumen.destroy')); ?>",
            method: "POST",
            data: {
                _token: _token,
                id: id
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /usr/share/nginx/html/disperkimtan/resources/views/admin/dokumen/index.blade.php ENDPATH**/ ?>