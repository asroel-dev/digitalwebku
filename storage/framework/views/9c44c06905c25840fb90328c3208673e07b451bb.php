    ...
    <div class="col-xl-3">
        <a href="<?php echo e(route('agenda.index')); ?>" class="card bg-body hoverable card-xl-stretch mb-xl-8">
            <div class="card-body shadow">
                ...
                <div class="text-inverse-body fw-bolder fs-2 mb-2 mt-5"><?php echo e($clientCount); ?></div>
                <div class="fw-bold text-inverse-body fs-7">Client</div>
            </div>
        </a>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asrulramadhan/Sites/sipbm-new/pastiberaksi/resources/views/home.blade.php ENDPATH**/ ?>