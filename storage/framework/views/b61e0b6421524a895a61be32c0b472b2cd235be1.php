        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('berita.create')); ?>" class="btn btn-primary btn-sm mb-5">+ Tambah Berita</a>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asrulramadhan/Laravel/digitalwebku/resources/views/admin/berita/index.blade.php ENDPATH**/ ?>