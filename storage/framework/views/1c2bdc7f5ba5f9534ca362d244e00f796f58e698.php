...
<form action="<?php echo e(route('berita.update',$data->id)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control <?php $__errorArgs = ['isi_berita'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="isi_berita" id="isi_berita"><?php echo e($data->isi_berita); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" name="kategori_id">
                            ...
                            <option value="<?php echo e($category->id); ?>" <?php if($category->id == $data->kategori_id): ?> selected <?php endif; ?>><?php echo e($category->name); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asrulramadhan/Sites/satpol/resources/views/admin/berita/edit.blade.php ENDPATH**/ ?>