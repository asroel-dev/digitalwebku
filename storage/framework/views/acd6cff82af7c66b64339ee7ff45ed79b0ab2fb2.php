                ...
                <div class="sidebar">
                    <div class="sidebar__single sidebar__search">
                        <form action="/berita" class="sidebar__search-form">
                            <input type="search" class="form-control" name="search" value="<?php echo e(request('search')); ?>" type="text" placeholder="Cari Berita ..." />
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asrulramadhan/Laravel/digitalwebku/resources/views/frontend/detailblog.blade.php ENDPATH**/ ?>