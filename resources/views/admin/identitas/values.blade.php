    ...
    <div class="card">
        <form id="kt_project_settings_form" class="form" action="{{ route('about.update', $data->id_identitas) }}"
            ...
            <div class="card-body p-9">
                <div class="row mb-8">
                    <div class="col-xl-3">
                        <div class="fs-6 fw-bold mt-2 mb-3">Title Values (en)</div>
                    </div>
                ...
                <div class="row mb-8">
                    <div class="col-xl-3">
                        <div class="fs-6 fw-bold mt-2 mb-3">Description (en)</div>
                    </div>
                    <div class="col-xl-9 fv-row">
                ...
                <div class="row mb-8">
                    <div class="col-xl-3">
                        <div class="fs-6 fw-bold mt-2 mb-3">Judul (ind)</div>
                    </div>
                    <div class="col-xl-9 fv-row">
                ...
                <div class="row mb-8">
                    <div class="col-xl-3">
                        <div class="fs-6 fw-bold mt-2 mb-3">Deskripsi (ind)</div>
                    </div>
                    <div class="col-xl-9 fv-row">
                                            ...
                                            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                <form method="POST" class="form"
                                                    ...
                                                    <div class="mb-13 text-center">
                                                        ...
                                                        <h1 class="mb-3">Edit Data Value </h1>

                                                    </div>
                                                    <div class="d-flex flex-column mb-8 fv-row">
                                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                            <span class="required">Value Title (en)</span>
                                                    ...
                                                    <div class="d-flex flex-column mb-8 fv-row">
                                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                            <span class="required">Judul Value (id)</span>
                                                            <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                                data-bs-toggle="tooltip" title="Masukkan Nama Manu"></i>
                                                        </label>
