                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                <form method="post" class="form"
                                                    action="{{ route('operations.update', $d->id_identitas) }}">
                                                    @csrf
                                                    ...
                                                    <div class="d-flex flex-column mb-8 fv-row">
                                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                            <span class="required">Deskripsi (En)</span>
                                                            <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                    ...
                                                    <div class="d-flex flex-column mb-8 fv-row">
                                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                            <span class="required">Titik X (%)</span>
                                                            <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                                data-bs-toggle="tooltip" title="Masukkan Titik X "></i>
                                                        </label>
                                                        <input type="text" value="{{ $d->titik_x }}"
                                                            class="form-control form-control-solid @error('titik_x') is-invalid @enderror"
                                                            placeholder="" name="titik_x" required />
                                                        @error('titik_x')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                                                    ...
                                                    <div class="d-flex flex-column mb-8 fv-row">
                                                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                            <span class="required">Titik Y (%)</span>
                                                            <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                                data-bs-toggle="tooltip" title="Masukkan Titik Y"></i>
                                                        </label>
                                                        <input type="text" value="{{ $d->titik_y }}"
                                                            class="form-control form-control-solid @error('titik_y') is-invalid @enderror"
                                                            placeholder="" name="titik_y" required />
                                                        @error('titik_y')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
