...
<div class="card">
    ...
    <form id="kt_project_settings_form" class="form" action="{{route('identitas.update',$data->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body p-9">
            ...
            <div class="row mb-8">
                ...
                <div class="col-xl-9 fv-row">
                    <input type="text" class="form-control form-control-solid" value="{{$data->no_telp}}" name="no_telp" />
                </div>
            </div>
            <div class="row mb-8">
                <div class="col-xl-3">
