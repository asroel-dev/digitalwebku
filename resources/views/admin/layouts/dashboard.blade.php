...
<head>
    <base href="">
    <title>{{ $konfigurasi->nama_website }}</title>
    ...
    {{-- <link href="{{asset('assets_panel/plugins/custom/fullcalendar/fullcalendar.bundle.css')}}" rel="stylesheet" type="text/css" /> --}}
    ...
    <link href="{{asset('assets_panel/plugins/custom/datatables/datatables.bundle.css')}}" rel="stylesheet" type="text/css"/>
    @yield('css')
</head>
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed toolbar-tablet-and-mobile-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
    ...
    {{-- <script src="{{asset('assets_panel/plugins/custom/fullcalendar/fullcalendar.bundle.js')}}"></script> --}}
    <script src="{{asset('assets_panel/js/custom/widgets.js')}}"></script>
    {{-- <script src="{{asset('assets_panel/js/custom/apps/chat/chat.js')}}"></script> --}}
    {{-- <script src="{{asset('assets_panel/js/custom/modals/create-app.js')}}"></script> --}}
    {{-- <script src="{{asset('assets_panel/js/custom/modals/upgrade-plan.js')}}"></script> --}}
    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.10.25/js/jquery.dataTables.js"></script>
    <script src="{{asset('assets_panel/plugins/custom/datatables/datatables.bundle.js')}}"></script>
