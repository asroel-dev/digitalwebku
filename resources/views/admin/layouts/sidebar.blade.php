     ...
     <div class="aside-menu flex-column-fluid">
         <div class="hover-scroll-overlay-y my-2 py-5 py-lg-8" id="kt_aside_menu_wrapper" data-kt-scroll="true"
             ...
             <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                 ...
                 <div data-kt-menu-trigger="click" class="menu-item  @if (Route::is('kategori.index') || Route::is('kategoriberita.index') || Route::is('layanan.index')  ) show @endif menu-accordion">
                     ...
                     <div class="menu-sub menu-sub-accordion menu-active-bg">
                         <div class="menu-item ">
                             <a class="menu-link @if (Route::is('kategori.index')) active @endif"
                         ...
                         <div class="menu-item ">
                            <a class="menu-link @if (Route::is('kategoriberita.index')) active @endif"
                                href="{{ route('kategoriberita.index') }}">
                                <span class="menu-icon">
                                    <i class="bi bi-app fs-3"></i>
                                </span>
                 ...
                 <div class="menu-item">
                     <a class="menu-link @if (Route::is('berita.index') || Route::is('berita.create') || Route::is('berita.edit')) active @endif"
                 ...
                 <div class="menu-item">
                     <a class="menu-link @if (Route::is('halaman.index') || Route::is('halaman.create') || Route::is('halaman.edit')) active @endif"
                 ...
                 <div class="menu-item">
                     <a class="menu-link @if (Route::is('dokumen.index')) active @endif"
                 ...
                 {{-- <div class="menu-item">
                    <a class="menu-link @if (Route::is('faq.index')) active @endif"
                 ...
                 <div class="menu-item">
                     <a class="menu-link @if (Route::is('banner.index')) active @endif"
             ...
             <div class="menu-item">
                <a class="menu-link @if (Route::is('identitas.index')) active @endif"
            ...
            <div class="menu-item">
                <a class="menu-link @if (Route::is('sambutan.index')) active @endif"
            ...
            <div class="menu-item">
                <a class="menu-link @if (Route::is('galeri.gambar')) active @endif"
                    href="{{ route('galeri.gambar') }}">
                    <span class=" menu-icon">
                        <i class="bi bi-images fs-3"></i>
                    </span>
             ...
             <div class="menu-item">
                 <a class="menu-link @if (Route::is('menu.index')) active @endif"
             ...
             <div class="menu-item">
                 <a class="menu-link @if (Route::is('user.index')) active @endif"
