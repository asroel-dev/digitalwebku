    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <form method="POST" class="form" action="{{route('kategoriberita.store')}}">
                    @csrf
...
<div class="modal fade" id="editKategori" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <form class="form" action="{{route('kategoriberita.update')}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-13 text-center">
...
<script>
    $(document).ready(function() {
        ...
        function load_data(unit = '') {
            $('#tableCategory').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url: "{{route('kategoriberita.index')}}",
                    data: {
                        unit: unit,
                    }
                },
    ...
    function hapus(id) {
        var _token = "{{ csrf_token() }}";
        $.ajax({
            url: "{{ route('kategoriberita.destroy') }}",
            method: "POST",
            data: {
                _token: _token,
                id: id
