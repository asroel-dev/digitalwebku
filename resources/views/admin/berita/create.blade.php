        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12">
                <div class="card shadow mb-3 mb-4">
                    <div class="card-header py-3">
                        <a href="{{ route('berita.index') }}" class="btn btn-warning"><i class="fa fa-arrow-left"
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <input type="text"
                                ...
                                placeholder="Masukkan Judul Berita" name="judul" required  value="{{ old('judul')}}" />
                                @error('judul')
                        ...
                        <div class="form-group">
                            ...
                            <textarea cols="100" class="form-control @error('isi_berita') is-invalid @enderror" value="{{ old('isi_berita')}}"  name="isi_berita" id="isi_berita"></textarea>
                            @error('isi_berita')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
                ...
                <div class="card shadow mb-3 ">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <img src="{{ asset('assets_panel/image/no-image.jpg') }}" id="preview" alt=""
