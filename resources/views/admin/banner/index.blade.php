...
<div class="row mt-5">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <button class="btn btn-primary btn-sm mb-3" data-bs-toggle="modal" data-bs-target="#tambahGambar">+ Tambah Banner</button>
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <form method="POST" class="form" action="{{route('banner.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="mb-13 text-center">
                        <h1 class="mb-3">Tambah Banner</h1>
                    </div>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input type="text" class="form-control form-control-solid" placeholder="google.com" name="link" required />
                    </div>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <img src="{{asset('assets_panel/image/977x734.png')}}" id="preview" alt="" class="img-fluid mb-2" width="100%">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <form class="form" action="{{route('banner.update')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <img src="{{asset('assets_panel/image/977x734.png')}}" id="previewEdit" alt="" class="img-fluid mb-2" width="100%">
                        <input type="file" class="form-control @error('gambar') is-invalid @enderror" id="gambarEdit" name="gambar">
                    </div>
                    <div class="text-center">
                        <button type="reset" class="btn btn-light me-3">Cancel</button>
                        <button type="submit" class="btn btn-primary">Submit
