    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <form method="POST" class="form" action="{{route('layanan.store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <img src="{{asset('assets_panel/image/1200x500.jpg')}}" id="preview" alt="" class="img-fluid mb-2" width="100%">
...
<div class="modal fade" id="editLayanan" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <form class="form" action="{{route('layanan.update')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-13 text-center">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <img src="{{asset('assets_panel/image/1200x500.jpg')}}" id="previewEdit" alt="" class="img-fluid mb-2" width="100%">
                        <input type="file" class="form-control @error('gambar') is-invalid @enderror" id="imageEdit" name="gambar">
                    </div>
