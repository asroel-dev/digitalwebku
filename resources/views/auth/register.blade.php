                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('nama_website') }}" required
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" style="text-transform: lowercase;  margin: 0;"
                                                                ...
                                                                value="{{ old('subdomain') }}" required onkeydown="disallowSpaces(event)">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-icon position-relative">
                                                            ...
                                                            <input type="email"
                                                                class="form-control ps-5 @error('email') is-invalid @enderror" style="text-transform: lowercase;  margin: 0;"
                                                                placeholder="" name="email"
                                                                value="{{ old('email') }}" required onkeydown="disallowSpaces(event)"
                                                                autocomplete="email">
                                                            @error('email')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
